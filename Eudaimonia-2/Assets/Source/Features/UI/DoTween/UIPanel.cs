    ...
    public class UIPanel : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            switch (_animationType)
            {
                ...
                case PanelAnimationType.ElasticFromBottom: _slideOffset = new Vector2(0, -Screen.height); break;
                case PanelAnimationType.SlideFromTop:
                case PanelAnimationType.ElasticFromTop: _slideOffset = new Vector2(0, Screen.height); break;
                case PanelAnimationType.SlideFromLeft: _slideOffset = new Vector2(-Screen.width, 0); break;
                case PanelAnimationType.SlideFromRight: _slideOffset = new Vector2(Screen.width, 0); break;
                default: _slideOffset = Vector2.zero; break;
            }

            switch (_animationType)
            {
                case PanelAnimationType.FadeOnly: _showAction = PlayFadeOnlyShow; _hideAction = PlayFadeOnlyHide; break;
                case PanelAnimationType.FadeScale: _showAction = PlayFadeScaleShow; _hideAction = PlayFadeScaleHide; break;
                case PanelAnimationType.SlideFromBottom:
                case PanelAnimationType.SlideFromTop:
                case PanelAnimationType.SlideFromLeft:
                case PanelAnimationType.SlideFromRight: _showAction = () => PlaySlideShow(_slideOffset); _hideAction = () => PlaySlideHide(_slideOffset); break;
                case PanelAnimationType.PopBounce: _showAction = PlayPopBounceShow; _hideAction = PlayPopBounceHide; break;
                case PanelAnimationType.ElasticFromBottom:
                case PanelAnimationType.ElasticFromTop: _showAction = () => PlayElasticSlideShow(_slideOffset); _hideAction = () => PlayElasticSlideHide(_slideOffset); break;
                case PanelAnimationType.FlipHorizontal: _showAction = PlayFlipHorizontalShow; _hideAction = PlayFlipHorizontalHide; break;
                case PanelAnimationType.FlipVertical: _showAction = PlayFlipVerticalShow; _hideAction = PlayFlipVerticalHide; break;
                case PanelAnimationType.RotateFadeIn: _showAction = PlayRotateFadeInShow; _hideAction = PlayRotateFadeInHide; break;
                case PanelAnimationType.ZoomOut: _showAction = PlayZoomOutShow; _hideAction = PlayZoomOutHide; break;
                case PanelAnimationType.ShakeAppear: _showAction = PlayShakeAppearShow; _hideAction = PlayFadeOnlyHide; break;
                case PanelAnimationType.SwingIn: _showAction = PlaySwingInShow; _hideAction = PlaySwingInHide; break;
                default: _showAction = PlayFadeOnlyShow; _hideAction = PlayFadeOnlyHide; break;
            }
        }
        ...
        {
            if (_panelStack.Contains(this)) return;
        ...
        {
            _canvasGroup.DOFade(0f, _duration).SetUpdate(true).SetId(this).OnComplete(() => gameObject.SetActive(false));
        }
        ...
        private void PlayFadeScaleHide()
        {
            ...
            _content.DOScale(0.8f, _duration).SetEase(Ease.InBack).SetUpdate(true).SetId(this).OnComplete(() => gameObject.SetActive(false));
        }
        ...
        {
            _canvasGroup.DOFade(0f, _duration).SetUpdate(true).SetId(this);
            _content.DOAnchorPos(_originalAnchoredPos + offset, _duration).SetEase(Ease.InCubic).SetUpdate(true).SetId(this).OnComplete(() => gameObject.SetActive(false));
        }
        ...
        private void PlayElasticSlideHide(Vector2 offset)
        {
            ...
            _content.DOAnchorPos(_originalAnchoredPos + offset, _duration * 0.7f).SetEase(Ease.InBack).SetUpdate(true).SetId(this).OnComplete(() => gameObject.SetActive(false));
        }
        ...
        private void PlayPopBounceHide()
        {
            ...
            _content.DOScale(0.5f, d).SetEase(Ease.InBack).SetUpdate(true).SetId(this).OnComplete(() => gameObject.SetActive(false));
        }
        ...
        private void PlayFlipHorizontalHide()
        {
            ...
            _content.DOLocalRotate(new Vector3(0f, 90f, 0f), _duration).SetEase(Ease.InBack).SetUpdate(true).SetId(this).OnComplete(() => gameObject.SetActive(false));
        }
        ...
        {
            _canvasGroup.DOFade(0f, _duration * 0.3f).SetDelay(_duration * 0.5f).SetUpdate(true).SetId(this);
            _content.DOLocalRotate(new Vector3(90f, 0f, 0f), _duration).SetEase(Ease.InBack).SetUpdate(true).SetId(this).OnComplete(() => gameObject.SetActive(false));
        }
        ...
        private void PlayRotateFadeInHide()
        {
            ...
            _content.DOScale(0.85f, _duration).SetEase(Ease.InBack).SetUpdate(true).SetId(this).OnComplete(() => gameObject.SetActive(false));
        }
        ...
        {
            _canvasGroup.DOFade(0f, _duration).SetUpdate(true).SetId(this);
            _content.DOScale(1.3f, _duration).SetEase(Ease.InCubic).SetUpdate(true).SetId(this).OnComplete(() => gameObject.SetActive(false));
        }
        ...
        private void PlaySwingInHide()
        {
            ...
            _content.DOLocalRotate(new Vector3(0f, 0f, 25f), _duration * 0.7f).SetEase(Ease.InCubic).SetUpdate(true).SetId(this).OnComplete(() => gameObject.SetActive(false));
        }
